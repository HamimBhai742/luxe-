                        ...
                        {activeMenuId === u.id && (
                          <div className="absolute right-6 mt-1.5 w-28 origin-top-right rounded-xl border border-zinc-200 bg-white p-1 shadow-xl dark:border-zinc-800 dark:bg-zinc-900 z-50 text-left">
                            ...
                            <button
                              ...
                              className="flex w-full items-center gap-2 rounded-lg px-2.5 py-1.5 text-xs font-bold text-red-650 hover:bg-red-50 dark:text-red-455 dark:hover:bg-red-955/20 transition-colors cursor-pointer"
                            >
                              <svg className="h-4 w-4 text-red-450" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
