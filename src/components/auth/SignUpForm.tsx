  ...
  return (
    <div className="w-full flex flex-col items-center">
      ...
      <form onSubmit={handleSubmit} className="w-full space-y-4">
        {/* Full Name */}
        <div>
          <label htmlFor="name" className="block text-xs font-semibold tracking-wide text-zinc-700 dark:text-zinc-300 uppercase">
            Full Name
          </label>
        ...
        <div className="flex items-start text-xs sm:text-sm">
          ...
          <label htmlFor="agree-terms" className="ml-2 text-zinc-600 dark:text-zinc-400">
            I agree to the{" "}
            <a href="/terms" className="underline font-semibold hover:text-zinc-800 dark:hover:text-zinc-200">
              Terms of Service
            </a>{" "}
            and{" "}
            <a href="/privacy" className="underline font-semibold hover:text-zinc-800 dark:hover:text-zinc-200">
              Privacy Policy
            </a>
          </label>
        </div>
