        ...
        <header className="sticky top-0 z-20 flex h-16 items-center justify-between border-b border-zinc-200/80 dark:border-zinc-800 bg-white/90 dark:bg-zinc-950/90 px-4 sm:px-6 lg:px-8 backdrop-blur-md">
          ...
          <div className="flex items-center gap-3.5 flex-1 max-w-lg">
            ...
            <button
              ...
              className="md:hidden rounded-lg p-1.5 text-zinc-550 hover:bg-zinc-150 hover:text-zinc-800 dark:text-zinc-400 dark:hover:bg-zinc-900 cursor-pointer"
            >
            ...
            <form onSubmit={handleSearchSubmit} className="relative w-full flex items-center">
              <svg className="absolute left-3.5 h-4.5 w-4.5 text-zinc-450 pointer-events-none" fill="none" viewBox="0 0 24 24" strokeWidth="2" stroke="currentColor">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2 rounded-xl border border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-900 text-xs font-semibold text-zinc-700 dark:text-zinc-300 outline-none focus:border-zinc-300 dark:focus:border-zinc-700 focus:bg-white dark:focus:bg-zinc-950 transition-all placeholder:text-zinc-450"
              />
            </form>
          </div>
          ...
          <div className="flex items-center gap-4 sm:gap-6">
            ...
            <button
              ...
              className="relative text-zinc-500 hover:text-zinc-800 dark:text-zinc-450 dark:hover:text-white transition-colors cursor-pointer"
              title="Notifications"
            >
              ...
              <span className="absolute top-0 right-0 flex h-2 w-2 rounded-full bg-red-550"></span>
            </button>

            {/* Grid app-launcher icon */}
            <button
              onClick={() => toast.info("Apps launcher coming soon!")}
              className="text-zinc-500 hover:text-zinc-800 dark:text-zinc-450 dark:hover:text-white transition-colors cursor-pointer"
              title="System Apps"
            >
